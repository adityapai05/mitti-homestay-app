...
//TODO: Replace with real data fetching for recommended homestays
  ...
  return (
    <section className="bg-mitti-beige pt-12 px-4 text-center">
      ...
      <p className="text-md sm:text-xl text-mitti-dark-brown mb-8">
        Our most loved rural stays - chosen for their stories, their soul, and
