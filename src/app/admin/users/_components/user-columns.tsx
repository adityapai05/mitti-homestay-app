...
export const userColumns = (
...

  {
    ...
    header: ({ column }) => (
      <Button
        ...
        className="p-0 h-auto text-left font-medium text-mitti-dark-brown cursor-pointer"
      >
        Role
...

  {
    ...
    sortingFn: (a, b) => {
      const order = ["REJECTED", "PENDING", "VERIFIED", ""];
      const aVal = a.original.hostProfile?.verificationStatus ?? "";
      const bVal = b.original.hostProfile?.verificationStatus ?? "";
