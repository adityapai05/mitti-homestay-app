            ...
            <Select onValueChange={handleSortChange} value={sort} >
              ...
              <SelectContent className="bg-mitti-brown text-mitti-beige border-mitti-cream rounded-md shadow-lg">
                <SelectItem
                  ...
                  className="hover:bg-mitti-khaki focus:bg-mitti-khaki rounded-md"
                >
                  Newest
                </SelectItem>
                <SelectItem
                  ...
                  <PaginationPrevious
                    ...
                    className={`${
                      currentPage === 1
                        ...
                        : "hover:bg-mitti-khaki"
                    } text-mitti-beige rounded-md px-3 py-1`}
                      ...
                      <PaginationLink
                        ...
                        className={`${
                          page === currentPage
                            ...
                            : "hover:bg-mitti-khaki text-mitti-beige"
